...
final class Message {
  const Message({
    ...
    this.pendingDeletionTransactionIds = const [],
  });
  ...
  /// Id delle transazioni che l'assistente ha individuato per una richiesta
  /// di eliminazione. Non vengono mai cancellate automaticamente: la Chat
  /// mostra una conferma esplicita prima di eseguire l'azione.
  final List<String> pendingDeletionTransactionIds;
  ...
  bool operator ==(Object other) =>
      ...
      _listEquals(
          other.pendingDeletionTransactionIds, pendingDeletionTransactionIds);
  ...
  int get hashCode => Object.hash(
        ...
        Object.hashAll(pendingDeletionTransactionIds),
      );
